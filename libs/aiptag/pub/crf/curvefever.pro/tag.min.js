...
function aipAPI() {
	...
	try{
		...
		//var e = ["\n %c %c %c %c AdinPlay v"+aiptag.settings.sVersion+" ✰ "+aiptag.settings.sPubName+" ✰ "+aip_pbjs.version+" ✰  %c  %c  ads by http://www.adinplay.com/  %c %c %c %c \n\n", 'background:url("libs/aiptag/assets/console-adinplay-logo.png");padding:30px 115px;background-repeat:no-repeat;', "background: #9C0013; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF; background: #030307; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF;background: #DB0028; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;"];
